...
object MathUtils {
     ...
     */
    const val GE_MIN: Int = -342
    const val GE_MAX: Int = 324
    ...
    private val pow10 = longArrayOf(
        ...
        10 * 1000000000000000000L,
    )

    /**
     * Returns 10<sup>`e`</sup> as an unsigned long.
     *
     * @param e The exponent which must meet 0  `e`  `N`.
     * @return 10<sup>`e`</sup>.
     */
    ...
    /**
     * Returns max{e : 10<sup>e</sup>  2<sup>`q`</sup>}.
     *
     *
     * The result is correct when |`q`|  6_432_162.
     * Otherwise, the result is undefined.
     *
     * @param q The exponent of 2, which should meet
     * |`q`|  6_432_162 for safe results.
     * @return log<sub>10</sub>2<sup>`q`</sup>.
     */
    fun flog10pow2(q: Int): Int {
        return (q * C_10 shr Q_10).toInt()
    }

    /**
     * Returns max{e : 10<sup>e</sup>  3/4  2<sup>`q`</sup>}.
     *
     *
     * The result is correct when
     * -3_606_689  `q`  3_150_619.
     * Otherwise, the result is undefined.
     *
     * @param q The exponent of 2, which should meet
     * -3_606_689  `q`  3_150_619 for safe results.
     * @return log<sub>10</sub>(3/4
     * 2<sup>`q`</sup>).
     */
    fun flog10threeQuartersPow2(q: Int): Int {
        return (q * C_10 + A_10 shr Q_10).toInt()
    }

    /**
     * Returns max{q : 2<sup>q</sup>  10<sup>`e`</sup>}.
     *
     *
    ...
    fun g1(e: Int): Long {
        return g[e - GE_MIN shl 1]
    }

    /* See the discussion above for the meaning of g0. */
    fun g0(e: Int): Long {
        return g[e - GE_MIN shl 1 or 1]
    }
    ...
    private val g = longArrayOf(
        //         g1,                     g0,                e
        0x777A29EB491DEB2DL, 0x044FEA8A41A84ED0L,  // -342
        0x4AAC5A330DB2B2FCL, 0x12B1F29669093142L,  // -341
        0x5D5770BFD11F5FBBL, 0x175E6F3C034B7D93L,  // -340
        0x74AD4CEFC56737A9L, 0x7D360B0B041E5CF8L,  // -339
        0x48EC5015DB6082CAL, 0x1E41C6E6E292FA1BL,  // -338
        0x5B27641B5238A37CL, 0x65D238A09B37B8A2L,  // -337
        0x71F13D2226C6CC5BL, 0x7F46C6C8C205A6CAL,  // -336
        0x4736C635583C3FB9L, 0x3F8C3C3D7943883EL,  // -335
        0x590477C2AE4B4FA7L, 0x6F6F4B4CD7946A4EL,  // -334
        0x6F4595B359DE2391L, 0x6B4B1E200D7984E1L,  // -333
        0x458B7D90182AD63BL, 0x130EF2D4086BF30DL,  // -332
        0x56EE5CF41E358BC9L, 0x77D2AF890A86EFD0L,  // -331
        0x6CA9F43125C2EEBCL, 0x35C75B6B4D28ABC4L,  // -330
        0x43EA389EB799D535L, 0x619C992310396B5BL,  // -329
